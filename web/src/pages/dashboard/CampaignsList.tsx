        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          {activeTab === 'bulk' && (
            <div className="bg-white shadow rounded-lg p-6">
              {isPaidTier ? (
                <BulkUploadTab
                  templateType="campaigns"
                  onUpload={handleBulkUpload}
                  title="Bulk Campaign Upload"
                  description="Upload multiple campaigns at once using a CSV file"
                  instructions={[
                    'Download the CSV template below',
                    'Fill in your campaign data following the template format',
